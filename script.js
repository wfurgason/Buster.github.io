...
2. The Smart styles.css (Root Folder)
Add these specific rules to handle the visual "Unlock."

CSS
/* Public State: Blurred and Banner shown */
#merchList {
  position: relative;
}
...
/* Secret Test Mode: Clear and Interactive */
