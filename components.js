...
(function () {
  ...
  if (footer) {
    footer.innerHTML = [
      ...
      '    <a href="https://www.tiktok.com/@bustertheband" target="_blank" class="social-icon">TikTok</a>',
      '    <a href="https://www.facebook.com/profile.php?id=61567940656919" target="_blank" class="social-icon">Facebook</a>',
      '    <a href="https://www.threads.com/@bustertheband" target="_blank" class="social-icon">Threads</a>',
      '    <a href="https://x.com/BusterSLC" target="_blank" class="social-icon">X</a>',
      '  </div>',
